...
const users = [
    ...
    { name: 'Charlie Dave', email: 'charlie@evently.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@evently.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@evently.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@evently.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@evently.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@evently.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@evently.com');
        console.log('User Email:  user@evently.com');
