        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-6">
          <div>
            ...
            <button
              ...
              className="rounded-full border border-purple-200 bg-white px-5 py-3 font-bold text-purple-600 transition hover:bg-purple-50"
            >
              {isFavorite(event._id) ? "❤️ Saved" : "♡ Save Event"}
            </button>
